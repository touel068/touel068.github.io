...
function DinosaursAfrica() {
    const dinos = [
        ...
        { name: 'Troodon', continent: 'North America', image: 'https://www.nhm.ac.uk/resources/nature-online/life/dinosaurs/dinosaur-directory/images/reconstruction/small/troo.jpg', url:'https://youtu.be/lIo7cG0Mt4s' },
  ...
  return (
    <div className="dinosaurs">
      ...
      <div className="continentTitle"><h1>Africa</h1></div>
      <div className="allCards">
      {dinos.filter(first => first.continent === "Africa").map(dino => (
...
export default DinosaursAfrica;
